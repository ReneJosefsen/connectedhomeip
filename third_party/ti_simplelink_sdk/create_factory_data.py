...
def create_hex_file(args):
    ...
    subprocess.call(['arm-none-eabi-objcopy', args.factory_data_hex_file,
                    '--input-target', 'ihex', '--output-target', 'binary', 'temp.bin'])
    subprocess.call(['arm-none-eabi-objcopy', 'temp.bin', '--input-target', 'binary', '--output-target',
