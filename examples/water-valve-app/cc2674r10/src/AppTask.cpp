...
int AppTask::Init()
{
    ...
    chip::app::Clusters::ValveConfigurationAndControl::SetDefaultDelegate(sWaterValveEndpoint, &sValveDelegate);
...
void AppTask::ToogleValveState(intptr_t arg)
{
    ...
    chip::app::Clusters::ValveConfigurationAndControl::Attributes::CurrentState::Get(sWaterValveEndpoint, attributeValue);
    ...
    if (attributeValue.IsNull())
    {
        ...
        chip::app::Clusters::ValveConfigurationAndControl::SetValveLevel(sWaterValveEndpoint, level, duration);
    ...
    else
    {
        ...
        chip::app::Clusters::ValveConfigurationAndControl::CloseValve(sWaterValveEndpoint);
        GetAppTask().CloseValve();
    }
}
