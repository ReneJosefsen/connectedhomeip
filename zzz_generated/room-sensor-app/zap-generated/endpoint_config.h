...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 13, 158 }, { ZAP_CLUSTER_INDEX(13), 3, 25 }, { ZAP_CLUSTER_INDEX(16), 3, 27 },                     \
            { ZAP_CLUSTER_INDEX(19), 3, 27 }, { ZAP_CLUSTER_INDEX(22), 3, 27 },                                                    \
    }
...
#define FIXED_DEVICE_TYPES                                                                                                         \
    {                                                                                                                              \
        { 0x0016, 1 }, { 0x0302, 1 }, { 0x0307, 1 }, { 0x0106, 1 }, { 0x0305, 1 }                                                  \
    }
